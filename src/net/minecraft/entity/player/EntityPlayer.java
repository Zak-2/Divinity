...
import divinity.module.impl.combat.KeepSprint;
import divinity.module.impl.render.TargetHUD;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public TargetHUD.THud targetHud = null;
                    ...
                    if (flag2) {
                        if (i > 0) {
                            ...
                            if (this instanceof EntityPlayerSP) {
                                KeepSprint ks = ClientManager.getInstance().getModuleManager().keepSprint;
                                this.motionX *= ks.isState() ? ks.motionX.getValue().doubleValue() : 0.6D;
                                this.motionZ *= ks.isState() ? ks.motionZ.getValue().doubleValue() : 0.6D;
                                if (ks.isState() && ks.preventStopSprint.getValue()) {
                                    // Does Nothing Here
