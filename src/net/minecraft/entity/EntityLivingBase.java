...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        return this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) : (int) ((this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6)
                * (ClientManager.getInstance().getModuleManager().get(ItemAnimations.class).isState() ? ClientManager.getInstance().getModuleManager().itemAnimations.speedProperty.getValue().doubleValue() : 1));
    }
    ...
    protected void jump() {
        ...
        if (this.isPotionActive(Potion.jump)) this.motionY += ((float)(this.getActivePotionEffect(Potion.jump).getAmplifier() + 1) * 0.1F);
