...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public static <T extends INetHandler> void processPacket(T handler, Packet<T> packet) {
        packet.processPacket(handler);
    }

    public void wrapper$channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) {
        this.channelRead0(p_channelRead0_1_, p_channelRead0_2_);
    }

    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) {
        if (this.channel.isOpen()) {
            try {
                PacketEvent event = new PacketEvent(EventType.RECEIVE, p_channelRead0_2_);
