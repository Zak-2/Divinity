...
public class WorldInfo {
    ...
    public long getWorldTime() {
        if (ClientManager.getInstance().getModuleManager().atmosphere.updateWorldTime()) {
            return ClientManager.getInstance().getModuleManager().atmosphere.getWorldTime();
        } else {
    ...
    public boolean isThundering() {
        if (ClientManager.getInstance().getModuleManager().atmosphere.overrideWeather()) {
            return ClientManager.getInstance().getModuleManager().atmosphere.overrideThundering();
        }
    ...
    public boolean isRaining() {
        if (ClientManager.getInstance().getModuleManager().atmosphere.overrideWeather()) {
            return ClientManager.getInstance().getModuleManager().atmosphere.overrideRaining();
        }
        return this.raining;
    }
