    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (this.showSelectionBox && this.isSelected(j)) {
                ...
                RenderUtils.drawRect(i1, k - 2, j1, (double) (k + l + 3), new Color(128, 128, 128, 255).getRGB());
                RenderUtils.drawRect(i1 + 1, k - 1, j1 - 1, (double) (k + l + 2), new Color(0, 0, 0, 255).getRGB());
            }
