...
public class Gui {
    ...
    public static void drawBorderedRect(int left, int y, int width, int height, int rectColor, int borderColor) {
        Gui.drawRect(left, y, left + width, y + height, rectColor);

        Gui.drawHorizontalLine(left - 1, left + width - 1, y, borderColor);

        Gui.drawHorizontalLine(left - 1, left + width, y + height, borderColor);

        Gui.drawVerticalLine(left - 1, y, y + height, borderColor);

        Gui.drawVerticalLine(left + width, y - 1, y + height, borderColor);
    }
