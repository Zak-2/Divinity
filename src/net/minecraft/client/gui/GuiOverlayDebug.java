...
import net.minecraft.client.optifine.SmartAnimations;
import net.minecraft.client.optifine.TextureAnimations;
import net.minecraft.client.optifine.reflect.Reflector;
import net.minecraft.client.optifine.util.MemoryMonitor;
import net.minecraft.client.optifine.util.NativeMemory;
    ...
    protected void renderDebugInfoLeft() {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (!Strings.isNullOrEmpty(s)) {
                int j = Fonts.INTER_MEDIUM.get(18).getHeight();
                int k = Fonts.INTER_MEDIUM.get(18).getStringWidth(s);
                int l = 2;
                int i1 = 2 + j * i;
                drawRect(1, i1 - 1, 2 + k + 1, i1 + j - 1, -1873784752);
                Fonts.INTER_MEDIUM.get(18).drawStringWithShadow(s, 2, i1, 14737632);
            }
        }
    }
    ...
    protected void renderDebugInfoRight(ScaledResolution scaledRes) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (!Strings.isNullOrEmpty(s)) {
                ...
                Fonts.INTER_MEDIUM.get(18).drawStringWithShadow(s, l, i1, 14737632);
            }
        }
    }
