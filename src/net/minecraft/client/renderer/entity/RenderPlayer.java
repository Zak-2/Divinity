...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
        ...
        if (clientPlayer.isSpectator()) {
            ...
            RenderItemStackEvent renderItemStackEvent = new RenderItemStackEvent(clientPlayer.inventory.getCurrentItem());
            ...
            if (itemstack == null) {
                ...
                if (clientPlayer.getItemInUseCount() > 0 || clientPlayer == Minecraft.getMinecraft().thePlayer &&
                        Minecraft.getMinecraft().getItemRenderer().fakeUseTicks > 0 && LocalPlayerUtils.isHoldingSword()) {
                    EnumAction enumaction = itemstack.getItemUseAction();

                    if (enumaction == EnumAction.BLOCK || clientPlayer == Minecraft.getMinecraft().thePlayer &&
                            Minecraft.getMinecraft().getItemRenderer().fakeUseTicks > 0 && LocalPlayerUtils.isHoldingSword()) {
