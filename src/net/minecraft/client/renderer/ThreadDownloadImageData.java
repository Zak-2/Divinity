...
import net.minecraft.client.optifine.http.HttpPipeline;
import net.minecraft.client.optifine.http.HttpRequest;
import net.minecraft.client.optifine.http.HttpResponse;
import net.minecraft.client.optifine.player.CapeImageBuffer;
