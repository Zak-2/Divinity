...
import net.minecraft.client.optifine.Log;
import net.minecraft.client.optifine.util.ArrayUtils;
...
import net.minecraft.util.vec.Matrix4f;
...
public class Reflector {
    ...
    public static ReflectorClass GuiMainMenu = new ReflectorClass(GuiClientMainMenu.class);
