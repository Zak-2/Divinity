...
import net.minecraft.client.optifine.config.EntityClassLocator;
import net.minecraft.client.optifine.config.IObjectLocator;
import net.minecraft.client.optifine.config.ItemLocator;
