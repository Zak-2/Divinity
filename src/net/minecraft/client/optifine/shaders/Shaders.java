...
import net.minecraft.client.optifine.CustomBlockLayers;
import net.minecraft.client.optifine.CustomColors;
import net.minecraft.client.optifine.GlErrors;
import net.minecraft.client.optifine.Lang;
import net.minecraft.client.optifine.config.ConnectedParser;
import net.minecraft.client.optifine.expr.IExpressionBool;
import net.minecraft.client.optifine.reflect.Reflector;
import net.minecraft.client.optifine.render.GlAlphaState;
import net.minecraft.client.optifine.render.GlBlendState;
import net.minecraft.client.optifine.shaders.config.*;
import net.minecraft.client.optifine.shaders.uniform.*;
import net.minecraft.client.optifine.texture.InternalFormat;
import net.minecraft.client.optifine.texture.PixelFormat;
import net.minecraft.client.optifine.texture.PixelType;
import net.minecraft.client.optifine.texture.TextureType;
import net.minecraft.client.optifine.util.EntityUtils;
import net.minecraft.client.optifine.util.PropertiesOrdered;
import net.minecraft.client.optifine.util.StrUtils;
