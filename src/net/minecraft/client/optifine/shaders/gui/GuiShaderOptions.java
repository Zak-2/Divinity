package net.minecraft.client.optifine.shaders.gui;

import net.minecraft.client.gui.FontRenderer;
import net.minecraft.client.gui.GuiButton;
import net.minecraft.client.gui.GuiScreen;
import net.minecraft.client.optifine.Lang;
import net.minecraft.client.optifine.gui.GuiScreenOF;
import net.minecraft.client.optifine.gui.TooltipManager;
import net.minecraft.client.optifine.gui.TooltipProviderShaderOptions;
import net.minecraft.client.optifine.shaders.Shaders;
import net.minecraft.client.optifine.shaders.config.ShaderOption;
import net.minecraft.client.optifine.shaders.config.ShaderOptionProfile;
import net.minecraft.client.optifine.shaders.config.ShaderOptionScreen;
