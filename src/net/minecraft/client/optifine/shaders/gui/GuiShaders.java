...
import net.minecraft.client.optifine.gui.TooltipProviderEnumShaderOptions;
import net.minecraft.client.optifine.shaders.Shaders;
import net.minecraft.client.optifine.shaders.ShadersTex;
import net.minecraft.client.optifine.shaders.config.EnumShaderOption;
