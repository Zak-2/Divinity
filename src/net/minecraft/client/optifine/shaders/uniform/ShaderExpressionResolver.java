package net.minecraft.client.optifine.shaders.uniform;

import net.minecraft.client.optifine.expr.ConstantFloat;
import net.minecraft.client.optifine.expr.IExpression;
import net.minecraft.client.optifine.expr.IExpressionResolver;
import net.minecraft.client.optifine.shaders.SMCLog;
