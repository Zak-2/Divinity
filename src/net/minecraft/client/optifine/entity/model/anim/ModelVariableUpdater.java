...
import net.minecraft.client.optifine.expr.ExpressionParser;
import net.minecraft.client.optifine.expr.IExpressionFloat;
import net.minecraft.client.optifine.expr.ParseException;
