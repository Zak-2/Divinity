package net.minecraft.client.optifine.entity.model;

import com.google.gson.*;
import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.client.optifine.config.ConnectedParser;
import net.minecraft.client.optifine.entity.model.anim.ModelUpdater;
import net.minecraft.client.optifine.entity.model.anim.ModelVariableUpdater;
import net.minecraft.client.optifine.player.PlayerItemParser;
import net.minecraft.client.optifine.util.Json;
