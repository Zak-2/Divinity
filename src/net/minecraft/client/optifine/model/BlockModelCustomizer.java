package net.minecraft.client.optifine.model;

import com.google.common.collect.ImmutableList;
import net.minecraft.block.state.IBlockState;
import net.minecraft.client.optifine.BetterGrass;
import net.minecraft.client.optifine.ConnectedTextures;
import net.minecraft.client.optifine.NaturalTextures;
import net.minecraft.client.optifine.SmartLeaves;
