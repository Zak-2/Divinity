...
import net.minecraft.client.optifine.config.RangeListInt;
import net.minecraft.client.optifine.render.Blender;
import net.minecraft.client.optifine.util.NumUtils;
import net.minecraft.client.optifine.util.SmoothFloat;
