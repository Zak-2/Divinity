...
public class ModelPlayer extends ModelBiped {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (ClientManager.getInstance().getModuleManager().esp.renderSkeletonEsp() && ClientManager.getInstance().getModuleManager().esp.isValid(entityIn))
            ClientManager.getInstance().getModuleManager().esp.addEntity((EntityPlayer) entityIn, this);
    }
