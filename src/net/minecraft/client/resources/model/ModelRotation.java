...
public enum ModelRotation {
    ...
    public net.minecraft.util.vec.Matrix4f getMatrix() {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (net.minecraft.util.vec.Matrix4f) Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[]{this}) : new net.minecraft.util.vec.Matrix4f(this.getMatrix4d());
    }
