...
entityplayer.setPositionAndRotation(d0, d1, d2, f, f1);
        ...
        this.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ, f, f1, false));
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        PacketEvent event = new PacketEvent(EventType.SEND, p_147297_1_);
