...
public class PlayerControllerMP {
    ...
    public void resetBlockRemoving() {
        final PreventBlockBreakEvent event = new PreventBlockBreakEvent();
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        ...
        ClientManager.getInstance().getEventDispatcher().post(new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode));
