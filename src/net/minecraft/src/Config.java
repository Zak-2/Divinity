...
import net.minecraft.client.optifine.VersionCheckThread;
import net.minecraft.client.optifine.config.GlVersion;
import net.minecraft.client.optifine.gui.GuiMessage;
...
import net.minecraft.client.optifine.util.DisplayModeComparator;
