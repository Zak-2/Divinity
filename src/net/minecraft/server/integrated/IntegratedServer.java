...
import net.minecraft.client.optifine.ClearWater;
...
public class IntegratedServer extends MinecraftServer {
    ...
    protected void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String worldNameIn2) {
        ...
        if (flag) {
            WorldServer worldserver = this.isDemo() ? (WorldServer) (new DemoWorldServer(this, isavehandler, worldinfo, 0)).init() : (WorldServer) (new WorldServer(this, isavehandler, worldinfo, 0)).init();
            ...
            for (int j = 0; j < i; ++j) {
                ...
                WorldServer worldserver1 = k == 0 ? worldserver : (WorldServer) (new WorldServerMulti(this, isavehandler, k, worldserver)).init();
