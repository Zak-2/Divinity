...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener {
    ...
    public void tick() {
        ...
        if (this.startProfiling) this.startProfiling = false;
    ...
    public void updateTimeLightAndEntities() {
        ...
        for (int j = 0; j < this.worldServers.length; ++j) {
            ...
            if (j == 0 || this.getAllowNether()) {
                ...
                if (this.tickCounter % 20 == 0) this.serverConfigManager.sendPacketToAllPlayersInDimension(new S03PacketTimeUpdate(worldserver.getTotalWorldTime(), worldserver.getWorldTime(), worldserver.getGameRules().getBoolean("doDaylightCycle")), worldserver.provider.getDimensionId());
